#ifndef __MORGANA_BASE_MATH_PLANE_H__
#define __MORGANA_BASE_MATH_PLANE_H__
	...
	namespace Base
	{
		namespace Math
		{
			...
			public:
				...
				inline float	DotCoordinate(const Vector3& value) const	{ return d + Vector3::Dot(normal, value); }
