#ifndef __MORGANA_BASE_MATH_MATRIX_H__
#define __MORGANA_BASE_MATH_MATRIX_H__
	...
	namespace Base
	{
		namespace Math
		{
			...
			public:
				...
				static Matrix	CreateFromDirectionTranslationScale(const Vector3 *const direction, const Vector3*const pos, const Vector3 *const scale);
				static void		CreateFromDirectionTranslationScale(const Vector3 *const direction, const Vector3*const pos, const Vector3 *const scale, Matrix *const result);
				...
				static void		MoveDepthTo01(Matrix *const mat);
				static void		MoveDepthTo01(const Matrix *const mat, Matrix *const result);
