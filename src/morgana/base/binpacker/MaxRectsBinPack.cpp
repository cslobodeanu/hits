...
void MaxRectsBinPack::Insert(Array<RectSize> &rects, Array<Rect> &dst, FreeRectChoiceHeuristic method)
{
	dst.clear();

	while(rects.size() > 0)
	{
		int bestScore1 = Mathf::MaxInt;
		int bestScore2 = Mathf::MaxInt;
		int bestRectIndex = -1;
		Rect bestNode;
