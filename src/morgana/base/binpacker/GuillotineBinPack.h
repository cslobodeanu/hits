...
*/
#ifndef __MORGANA_BASE_BINPACKER_GUILLOTINE_BIN_PACK_H__
#define __MORGANA_BASE_BINPACKER_GUILLOTINE_BIN_PACK_H__

#include "BinPackerRect.h"
...
namespace BinPacker
{
	...
	public:
		...
		/// @param rectChoice The free rectangle choice heuristic rule to use.
		/// @param splitMethod The free rectangle split heuristic rule to use.
		void Insert(Array<RectSize> &rects, Array<Rect> &dst, bool merge,
		...
		Array<Rect> &GetFreeRectangles() { return freeRectangles; }
		...
		Array<Rect> &GetUsedRectangles() { return usedRectangles; }
