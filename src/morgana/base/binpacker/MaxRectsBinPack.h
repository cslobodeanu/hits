...
*/
#ifndef __MORGANA_BASE_BINPACKER_MAX_RECTS_BIN_PACK_H__
#define __MORGANA_BASE_BINPACKER_MAX_RECTS_BIN_PACK_H__
...
namespace BinPacker
{
	...
	public:
		...
		void Insert(Array<RectSize> &rects, Array<Rect> &dst, FreeRectChoiceHeuristic method);
